...
Feature: Premium user Exercise Module on Homepage
  ...
  #
  #@ExerciseTabs
  #Scenario Outline: Verify "<Field>" is displayed under "<Tab>" tab
    #Given User is on the Exercise section
    #When User clicks the "<Tab>" tab
    #Then "<Field>" should be displayed under "<Tab>" tab
#
    #Examples:
      #| Tab          | Field             |
      ...
      #| Warm Up      | Mark As Completed |
      #| Main Workout | Exercise Name     |
      #| Main Workout | Description       |
      #| Main Workout | Duration          |
      #| Main Workout | Calories          |
      #| Main Workout | Intensity Level   |
      #| Main Workout | Mark As Completed |
      #| Cool Down    | Exercise Name     |
      #| Cool Down    | Description       |
      #| Cool Down    | Duration          |
      #| Cool Down    | Calories          |
      #| Cool Down    | Intensity Level   |
      #| Cool Down    | Mark As Completed |
#

  @MarkAsCompleted
  Scenario Outline: Verify "<Scenario>" after clicking Mark As Completed button in "<Tab>" section
    Given User is on the Exercise section
    When User clicks the Mark As Completed button in "<Tab>" section
    Then "<Scenario>" should be displayed

    Examples:
      | Tab          | Scenario        |
      | Warm Up      | Success Dialog  |
      | Warm Up      | Completed       |
      | Warm Up      | Undo Option     |
      | Main Workout | Success Dialog  |
      | Main Workout | Completed       |
      | Main Workout | Undo Option     |
      | Cool Down    | Success Dialog  |
      | Cool Down    | Completed       |
      | Cool Down    | Undo Option     |
  ...
  @ExerciseSchedule
  Scenario: Verify navigation to "Today's Exercise Schedule" from Exercise section
    Given User is on the Exercise section
