...
public class PremiumUserPhysicalActivityFT_PF {
	
	WebDriver driver = DriverManager.getDriver();
	ConfigReader configFileReader = DriverManager.configReader();

	public PremiumUserPhysicalActivityFT_PF() {
	...
	public void saveActivityClick() { saveActivity.click(); }
	...
	public void addPresentInput(String value) { presenceInput.sendKeys(value); }
	
	public boolean presentInputIsEmpty() { return presenceInput.getText().isBlank(); }
