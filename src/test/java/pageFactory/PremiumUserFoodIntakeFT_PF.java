...
public class PremiumUserFoodIntakeFT_PF {
	
	WebDriver driver = DriverManager.getDriver();
	ConfigReader configFileReader = DriverManager.configReader();

	public PremiumUserFoodIntakeFT_PF() {
	...
	@FindBy(xpath = "//div[contains(@id,'react-day-picker')]") WebElement calendar;
	@FindBy(xpath = "//button[@name='previous-month']") WebElement previousDate;
	@FindBy(xpath = "//button[@name='next-month']") WebElement nextDate;
	...
	public boolean calendarDisplayed() { return calendar.isDisplayed(); }
	
	public boolean previousDateDisplayed() { return previousDate.isDisplayed(); }
	
	public boolean nextDateDisplayed() { return nextDate.isDisplayed(); }
	
	public String getAlertText() { return driver.switchTo().alert().getText(); }
	
	public void saveFoodClick() { saveFoodButton.click(); }
	
	public void inputFoodSetValue(String value) {
		inputFood.sendKeys(value);
	}
	
	public void notesSetValue(String value) {
		notes.sendKeys(value);
	}
	
	public void clearInputFood() {
		inputFood.clear();
	}
	
	public void calorieInputSetValue(String value) {
		calorieInput.sendKeys(value);
	}
	
	public String getCalorieInput() {
		return calorieInput.getText();
	}
	
	public String getcalorieHelperText() {
